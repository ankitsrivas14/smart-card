  ...
  <div class="portal-type__inner-container">
    <div v-if="!activeEvent" class="bank-start__container">
      <div class="banks__start">
        <span>Click here to access electricity board account...</span>
        <button @click="showDialog = true">Proceed</button>
      </div>
    </div>
    <div class="active-event__container-bank" v-else>
      <button @click="handleBackToBank" class="back-btn">Logout</button>
    </div>
    <ElectricityDashboard v-if="activeEvent" />
    <SCDialog
...
import ElectricityDashboard from "@/components/features/Electricity/ElectricityDashboard";
